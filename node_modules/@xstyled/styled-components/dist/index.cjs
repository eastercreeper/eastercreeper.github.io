...
const useTransitionProperty = core.createUseGetter(
  system.th.transitionProperty,
  useTheme
);
...
const Preflight = styled$1.createGlobalStyle(
  ({ theme }) => system.getPreflightStyles(theme)
);
